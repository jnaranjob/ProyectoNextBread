...
namespace NextBreadDemo1._0 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class DetalleFacturaDataTable : global::System.Data.TypedTableBase<DetalleFacturaRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public DetalleFacturaRow AddDetalleFacturaRow(string CodigoVenta, long CodigoProducto, decimal Precio, int Cantidad, decimal SubTotal, string Descripcion) {
            ...
            private void InitClass() {
                ...
                this.columnCodigoProducto = new global::System.Data.DataColumn("CodigoProducto", typeof(long), null, global::System.Data.MappingType.Element);
                ...
                this.columnCodigoVenta.MaxLength = 20;
        ...
        public partial class DetalleFacturaRow : global::System.Data.DataRow {
            ...
            public string CodigoVenta {
                get {
                    return ((string)(this[this.tableDetalleFactura.CodigoVentaColumn]));
                }
                set {
                    this[this.tableDetalleFactura.CodigoVentaColumn] = value;
                }
            }
            ...
            public long CodigoProducto {
                get {
                    return ((long)(this[this.tableDetalleFactura.CodigoProductoColumn]));
                }
                set {
...
namespace NextBreadDemo1._0.DataSet1TableAdapters {
    ...
    public partial class DetalleFacturaTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [DetalleFactura] WHERE (([IdDetalle] = @Original_IdDetalle) AND ([CodigoVenta] = @Original_CodigoVenta) AND ([CodigoProducto] = @Original_CodigoProducto) AND ([Precio] = @Original_Precio) AND ([Cantidad] = @Original_Cantidad) AND ((@IsNull_SubTotal = 1 AND [SubTotal] IS NULL) OR ([SubTotal] = @Original_SubTotal)) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)))";
            ...
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CodigoVenta", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CodigoVenta", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.DeleteCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CodigoProducto", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CodigoProducto", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [DetalleFactura] ([CodigoVenta], [CodigoProducto], [Precio], [Cantidad], [SubTotal], [Descripcion]) VALUES (@CodigoVenta, @CodigoProducto, @Precio, @Cantidad, @SubTotal, @Descripcion);
SELECT IdDetalle, CodigoVenta, CodigoProducto, Precio, Cantidad, SubTotal, Descripcion FROM DetalleFactura WHERE (IdDetalle = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CodigoVenta", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CodigoVenta", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CodigoProducto", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CodigoProducto", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [DetalleFactura] SET [CodigoVenta] = @CodigoVenta, [CodigoProducto] = @CodigoProducto, [Precio] = @Precio, [Cantidad] = @Cantidad, [SubTotal] = @SubTotal, [Descripcion] = @Descripcion WHERE (([IdDetalle] = @Original_IdDetalle) AND ([CodigoVenta] = @Original_CodigoVenta) AND ([CodigoProducto] = @Original_CodigoProducto) AND ([Precio] = @Original_Precio) AND ([Cantidad] = @Original_Cantidad) AND ((@IsNull_SubTotal = 1 AND [SubTotal] IS NULL) OR ([SubTotal] = @Original_SubTotal)) AND ((@IsNull_Descripcion = 1 AND [Descripcion] IS NULL) OR ([Descripcion] = @Original_Descripcion)));
SELECT IdDetalle, CodigoVenta, CodigoProducto, Precio, Cantidad, SubTotal, Descripcion FROM DetalleFactura WHERE (IdDetalle = @IdDetalle)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CodigoVenta", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CodigoVenta", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@CodigoProducto", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CodigoProducto", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            ...
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CodigoVenta", global::System.Data.SqlDbType.NVarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CodigoVenta", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Original_CodigoProducto", global::System.Data.SqlDbType.BigInt, 0, global::System.Data.ParameterDirection.Input, 0, 0, "CodigoProducto", global::System.Data.DataRowVersion.Original, false, null, "", "", ""));
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::NextBreadDemo1._0.Properties.Settings.Default.PanaderiaConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT        IdDetalle, CodigoVenta, CodigoProducto, Precio, Cantidad, SubTotal," +
                " Descripcion\r\nFROM            DetalleFactura";
        ...
        public virtual int Fill(DataSet1.DetalleFacturaDataTable dataTable) {
        ...
        public virtual DataSet1.DetalleFacturaDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            DataSet1.DetalleFacturaDataTable dataTable = new DataSet1.DetalleFacturaDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(DataSet1.DetalleFacturaDataTable dataTable) {
        ...
        public virtual int Delete(int Original_IdDetalle, string Original_CodigoVenta, long Original_CodigoProducto, decimal Original_Precio, int Original_Cantidad, global::System.Nullable<decimal> Original_SubTotal, string Original_Descripcion) {
            this.Adapter.DeleteCommand.Parameters[0].Value = ((int)(Original_IdDetalle));
            if ((Original_CodigoVenta == null)) {
                throw new global::System.ArgumentNullException("Original_CodigoVenta");
            }
            else {
                this.Adapter.DeleteCommand.Parameters[1].Value = ((string)(Original_CodigoVenta));
            }
            this.Adapter.DeleteCommand.Parameters[2].Value = ((long)(Original_CodigoProducto));
        ...
        public virtual int Insert(string CodigoVenta, long CodigoProducto, decimal Precio, int Cantidad, global::System.Nullable<decimal> SubTotal, string Descripcion) {
            if ((CodigoVenta == null)) {
                throw new global::System.ArgumentNullException("CodigoVenta");
            }
            else {
                this.Adapter.InsertCommand.Parameters[0].Value = ((string)(CodigoVenta));
            }
            this.Adapter.InsertCommand.Parameters[1].Value = ((long)(CodigoProducto));
        ...
        public virtual int Update(string CodigoVenta, long CodigoProducto, decimal Precio, int Cantidad, global::System.Nullable<decimal> SubTotal, string Descripcion, int Original_IdDetalle, string Original_CodigoVenta, long Original_CodigoProducto, decimal Original_Precio, int Original_Cantidad, global::System.Nullable<decimal> Original_SubTotal, string Original_Descripcion, int IdDetalle) {
            if ((CodigoVenta == null)) {
                throw new global::System.ArgumentNullException("CodigoVenta");
            }
            else {
                this.Adapter.UpdateCommand.Parameters[0].Value = ((string)(CodigoVenta));
            }
            this.Adapter.UpdateCommand.Parameters[1].Value = ((long)(CodigoProducto));
            ...
            if ((Original_CodigoVenta == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((string)(Original_CodigoVenta));
            }
            this.Adapter.UpdateCommand.Parameters[8].Value = ((long)(Original_CodigoProducto));
        ...
        public virtual int Update(string CodigoVenta, long CodigoProducto, decimal Precio, int Cantidad, global::System.Nullable<decimal> SubTotal, string Descripcion, int Original_IdDetalle, string Original_CodigoVenta, long Original_CodigoProducto, decimal Original_Precio, int Original_Cantidad, global::System.Nullable<decimal> Original_SubTotal, string Original_Descripcion) {
            return this.Update(CodigoVenta, CodigoProducto, Precio, Cantidad, SubTotal, Descripcion, Original_IdDetalle, Original_CodigoVenta, Original_CodigoProducto, Original_Precio, Original_Cantidad, Original_SubTotal, Original_Descripcion, Original_IdDetalle);
        }
    }
